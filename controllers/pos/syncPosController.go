...
func SyncDataWithAPI(entrepriseID string) {
    ...
    externalDataList, err := fetchExternalDataFromAPI(entrepriseID)
    if err != nil {
...
func fetchExternalDataFromAPI(entrepriseID string) ([]models.Pos, error) {
    // Replace with the actual URL of your API
    apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/pos/all/%s", entrepriseID)
...
func fetchExternalDataItemFromAPI(dataID uint) (models.Pos, error) {
    // URL de l'API
    apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/pos/get/%d", dataID)
...
func updateExternalDataInAPI(data models.Pos) error {
    // URL de l'API
    apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/pos/update/%d", data.ID)
...
func deleteExternalDataInAPI(dataID uint) error {
	// URL de l'API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/pos/delete/%d", dataID)
