...
// Récupérer des données externes à partir de l'API
func fetchExternalDataFromAPI(code_entreprise string, pos_uuid string) ([]models.Ingredient, error) {
	// Replace with the actual URL of your API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/ingredients/%s/%s/all", code_entreprise, pos_uuid)
...
func fetchExternalDataItemFromAPI(dataUUID string) (models.Ingredient, error) {
	// URL de l'API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/ingredients/get/%s", dataUUID)
...
func updateExternalDataInAPI(data models.Ingredient) error {
	// URL de l'API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/ingredients/update/%s", data.UUID)
