...
func fetchExternalDataFromAPI(product_uuid string) ([]models.Stock, error) {
	...
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/stocks/all/%s", product_uuid)
...
func fetchExternalDataItemFromAPI(dataUUID string) (models.Stock, error) {
	// URL de l'API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/stocks/get/%s", dataUUID)
...
func updateExternalDataInAPI(data models.Stock) error {
	// URL de l'API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/stocks/update/%s", data.UUID)
