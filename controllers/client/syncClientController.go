...
func fetchExternalDataFromAPI(code_entreprise string) ([]models.Client, error) {
    ...
    apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/clients/%s/all", code_entreprise)
...
func fetchExternalDataItemFromAPI(dataID uint) (models.Client, error) {
    // URL de l'API
    apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/clients/get/%d", dataID)
    ...
    if resp.StatusCode != http.StatusOK {
        return models.Client{}, fmt.Errorf("failed to fetch data: %s", resp.Status)
    }
...
func sendLocalDataToAPI(data models.Client) error {
    ...
    apiURL := "https://i-pos-restaurant-api.up.railway.app/api/clients/create"
...
func updateExternalDataInAPI(data models.Client) error {
    // URL de l'API
    apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/clients/update/%d", data.ID)
...
func deleteExternalDataInAPI(dataID uint) error {
	// URL de l'API
	apiURL := fmt.Sprintf("https://i-pos-restaurant-api.up.railway.app/api/clients/delete/%d", dataID)
