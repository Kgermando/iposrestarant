    ...
    ((e, t) => {
      ...
      function u(e) {
        this._handle = null, this._finished = false, this._completed = false, this._halted = false, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = true, this._completeResults = {
          ...
          P(this._config.error) ? this._config.error(e2) : a && this._config.error && n.postMessage({
            workerId: v.WORKER_ID,
            error: e2,
            finished: false
          });
      ...
      function E(C) {
        ...
        this.parse = function(i2, t, r2) {
          ...
          for (var p2 = i2.indexOf(S, j), g2 = i2.indexOf(O, j), _2 = new RegExp(M(F) + M(L), "g"), m2 = i2.indexOf(L, j); ; ) if (i2[j] === L) for (m2 = j, j++; ; ) {
            if (-1 === (m2 = i2.indexOf(L, m2 + 1))) return r2 || u2.push({
              type: "Quotes",
              code: "MissingQuotes",
      ...
      return v.parse = function(e, t) {
        ...
        })()).userStep = t.step, i2.userChunk = t.chunk, i2.userComplete = t.complete, i2.userError = t.error, t.step = P(t.step), t.chunk = P(t.chunk), t.complete = P(t.complete), t.error = P(t.error), delete t.worker, i2.postMessage({
          input: e,
          config: t,
          workerId: i2.id
        });
        ...
        function e() {
          if (0 === h2.length) P(o2.complete) && o2.complete();
            ...
            if (P(o2.before)) {
              ...
              if ("object" == typeof s2) {
                if ("abort" === s2.action) return e2 = "AbortError", t = n2.file, i3 = n2.inputElem, r2 = s2.reason, void (P(o2.error) && o2.error({
                  name: e2
                }, t, i3, r2));
...
papaparse/papaparse.min.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-N336MEWE.js.map
