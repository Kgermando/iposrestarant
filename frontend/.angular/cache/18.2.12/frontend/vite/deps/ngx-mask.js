...
NgxMaskService.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function NgxMaskService_Factory(__ngFactoryType__) {
    return (ɵNgxMaskService_BaseFactory || (ɵNgxMaskService_BaseFactory = ɵɵgetInheritedFactory(NgxMaskService)))(__ngFactoryType__ || NgxMaskService);
  };
})();
...
NgxMaskPipe.ɵfac = function NgxMaskPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxMaskPipe)(ɵɵdirectiveInject(NgxMaskService, 16));
};
...
var NgxMaskModule = class _NgxMaskModule {
...
NgxMaskModule.ɵfac = function NgxMaskModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxMaskModule)();
};
NgxMaskModule.ɵmod = ɵɵdefineNgModule({
  type: NgxMaskModule,
  declarations: [NgxMaskDirective, NgxMaskPipe],
  exports: [NgxMaskDirective, NgxMaskPipe]
});
NgxMaskModule.ɵinj = ɵɵdefineInjector({});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxMaskModule, [{
    type: NgModule,
    args: [{
      exports: [NgxMaskDirective, NgxMaskPipe],
      declarations: [NgxMaskDirective, NgxMaskPipe]
