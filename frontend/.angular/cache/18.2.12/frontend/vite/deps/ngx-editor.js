...
function captureKeyDown(view, event) {
  ...
  } else if (code3 == 46 || mac && code3 == 68 && mods == "c") {
...
function closeRange(fragment, side, from2, to, depth, openEnd) {
  ...
  if (depth >= from2) inner = side < 0 ? node.contentMatchAt(0).fillBefore(inner, fragment.childCount > 1 || openEnd <= depth).append(inner) : inner.append(node.contentMatchAt(node.childCount).fillBefore(Fragment.empty, true));
...
function capturePaste(view, event) {
  ...
  setTimeout(() => {
    ...
    if (plainText) doPaste(view, target.value, null, view.input.shiftKey, event);
...
editHandlers.paste = (view, _event) => {
  ...
  let data = brokenClipboardAPI ? null : event.clipboardData;
  if (data && doPaste(view, data.getData("text/plain"), data.getData("text/html"), view.input.shiftKey, event)) event.preventDefault();
  ...
  if (!change) {
    if (typeOver && sel instanceof TextSelection && !sel.empty && sel.$head.sameParent(sel.$anchor) && !view.composing && !(parse.sel && parse.sel.anchor != parse.sel.head)) {
      ...
      if (parse.sel) {
        ...
        if (sel2 && !sel2.eq(view.state.selection)) view.dispatch(view.state.tr.setSelection(sel2));
      }
      return;
    }
  }
...
var markInputRule = (regexp, markType, attrs) => {
  return new InputRule(regexp, (state, match, start, end) => {
    ...
    return tr.addMark(from2, to, markType.create(attrs));
  });
};
...
function getBoundingClientRect(element, includeScale, isFixedStrategy, offsetParent) {
  ...
  let x = (clientRect2.left + (addVisualOffsets ? ((_win$visualViewport = win.visualViewport) == null ? void 0 : _win$visualViewport.offsetLeft) || 0 : 0)) / scale.x;
...
function modifiers(name, event, shift3) {
  if (event.altKey) name = "Alt-" + name;
  if (event.ctrlKey) name = "Ctrl-" + name;
  if (event.metaKey) name = "Meta-" + name;
  if (shift3 !== false && event.shiftKey) name = "Shift-" + name;
  return name;
}
...
function applyTransaction(history2, state, tr, options) {
  ...
  if (tr.getMeta(closeHistoryKey)) history2 = new HistoryState(history2.done, history2.undone, null, 0);
  let appended = tr.getMeta("appendedTransaction");
  if (tr.steps.length == 0) {
    return history2;
  } else if (appended && appended.getMeta(historyKey)) {
    if (appended.getMeta(historyKey).redo) return new HistoryState(history2.done.addTransform(tr, void 0, options, mustPreserveItems(state)), history2.undone, rangesFor(tr.mapping.maps[tr.steps.length - 1]), history2.prevTime);
    else return new HistoryState(history2.done, history2.undone.addTransform(tr, void 0, options, mustPreserveItems(state)), null, history2.prevTime);
...
function LinkComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("ngSubmit", function LinkComponent_div_2_Template_form_ngSubmit_1_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
    ...
    ɵɵelementEnd()();
    ɵɵelementStart(14, "div", 4)(15, "div", 5)(16, "label");
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(4);
    ɵɵtextInterpolate(ctx_r1.getLabel("url"));
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r1.href.touched && ctx_r1.href.invalid);
    ɵɵadvance(4);
    ɵɵtextInterpolate(ctx_r1.getLabel("text"));
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r1.text.touched && ctx_r1.text.invalid);
    ɵɵadvance(5);
    ɵɵtextInterpolate1(" ", ctx_r1.getLabel("openInNewTab"), " ");
    ɵɵadvance();
    ɵɵproperty("disabled", !ctx_r1.form.valid);
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r1.getLabel("insert"));
  }
}
var _c4 = (a0, a1) => ({
...
function DropdownComponent_div_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("mousedown", function DropdownComponent_div_2_div_1_Template_div_mousedown_0_listener($event) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction2(2, _c4, item_r2 === ctx_r2.activeItem, ctx_r2.disabledItems.includes(item_r2)));
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", ctx_r2.getName(item_r2), " ");
  }
}
...
function ImageComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 2)(1, "form", 3);
    ɵɵlistener("ngSubmit", function ImageComponent_div_2_Template_form_ngSubmit_1_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.insertLink($event));
    });
    ...
    ɵɵelement(12, "input", 9);
    ɵɵelementEnd()();
    ɵɵelementStart(13, "div", 4)(14, "div", 5)(15, "label", 6);
    ɵɵtext(16);
    ɵɵelementEnd();
    ɵɵelement(17, "input", 10);
    ɵɵelementEnd()();
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(4);
    ɵɵtextInterpolate(ctx_r1.getLabel("altText"));
    ɵɵadvance(5);
    ɵɵtextInterpolate(ctx_r1.getLabel("title"));
    ɵɵadvance(2);
...
function ColorPickerComponent_div_2_div_1_button_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("mousedown", function ColorPickerComponent_div_2_div_1_button_1_Template_button_mousedown_0_listener($event) {
...
function ColorPickerComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 2);
    ɵɵtemplate(1, ColorPickerComponent_div_2_div_1_Template, 2, 2, "div", 3);
    ɵɵelementStart(2, "button", 4);
    ɵɵlistener("mousedown", function ColorPickerComponent_div_2_Template_button_mousedown_2_listener($event) {
      ɵɵrestoreView(_r1);
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", ctx_r3.getLabel("remove"), " ");
  }
}
var _c7 = (a0, a1) => ({
...
function BubbleComponent_ng_container_0_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r2 = ɵɵnextContext().$implicit;
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction2(3, _c8, ctx_r2.activeItems.includes(item_r2), !ctx_r2.execulableItems.includes(item_r2)))("title", ctx_r2.getTitle(item_r2))("innerHTML", ctx_r2.getIcon(item_r2), ɵɵsanitizeHtml);
  }
}
...
function BubbleComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, BubbleComponent_ng_container_0_ng_container_1_div_1_Template, 1, 6, "div", 1)(2, BubbleComponent_ng_container_0_ng_container_1_div_2_Template, 1, 0, "div", 2);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    const item_r2 = ctx.$implicit;
...
ImageViewComponent.ɵfac = function ImageViewComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ImageViewComponent)();
};
ImageViewComponent.ɵcmp = ɵɵdefineComponent({
...
NgxEditorComponent.ɵfac = function NgxEditorComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxEditorComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ElementRef));
};
NgxEditorComponent.ɵcmp = ɵɵdefineComponent({
...
MenuService.ɵfac = function MenuService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MenuService)();
};
MenuService.ɵprov = ɵɵdefineInjectable({
  token: MenuService,
...
var NgxEditorServiceConfig = class {
  constructor() {
    this.locals = {};
    this.icons = {};
  }
};
NgxEditorServiceConfig.ɵfac = function NgxEditorServiceConfig_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxEditorServiceConfig)();
};
NgxEditorServiceConfig.ɵprov = ɵɵdefineInjectable({
...
NgxEditorService.ɵfac = function NgxEditorService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxEditorService)(ɵɵinject(NgxEditorServiceConfig, 8));
};
NgxEditorService.ɵprov = ɵɵdefineInjectable({
...
SanitizeHtmlPipe.ɵfac = function SanitizeHtmlPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SanitizeHtmlPipe)(ɵɵdirectiveInject(DomSanitizer, 16));
};
SanitizeHtmlPipe.ɵpipe = ɵɵdefinePipe({
  name: "sanitizeHtml",
...
var ToggleCommandComponent = class {
...
ToggleCommandComponent.ɵfac = function ToggleCommandComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ToggleCommandComponent)(ɵɵdirectiveInject(NgxEditorService), ɵɵdirectiveInject(MenuService));
};
ToggleCommandComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function ToggleCommandComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵproperty("innerHTML", ɵɵpipeBind1(1, 6, ctx.html), ɵɵsanitizeHtml)("title", ctx.getTitle(ctx.name));
    }
  },
...
var InsertCommandComponent = class {
  constructor(ngxeService, menuService) {
    this.ngxeService = ngxeService;
    this.menuService = menuService;
    this.disabled = false;
...
InsertCommandComponent.ɵfac = function InsertCommandComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || InsertCommandComponent)(ɵɵdirectiveInject(NgxEditorService), ɵɵdirectiveInject(MenuService));
};
InsertCommandComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function InsertCommandComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵproperty("innerHTML", ɵɵpipeBind1(1, 4, ctx.html), ɵɵsanitizeHtml)("title", ctx.getTitle(ctx.name));
    }
  },
  dependencies: [SanitizeHtmlPipe]
});
...
var LinkComponent = class {
  ...
  insertLink(e) {
    ...
    if (selection.empty) {
      Link.insert(text2, attrs)(state, dispatch);
...
LinkComponent.ɵfac = function LinkComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || LinkComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgxEditorService), ɵɵdirectiveInject(MenuService));
};
LinkComponent.ɵcmp = ɵɵdefineComponent({
  type: LinkComponent,
  selectors: [["ngx-link"]],
  ...
  template: function LinkComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵproperty("innerHTML", ɵɵpipeBind1(1, 7, ctx.icon), ɵɵsanitizeHtml)("title", ctx.title);
      ɵɵadvance(2);
      ɵɵproperty("ngIf", ctx.showPopup);
    }
  },
  dependencies: [NgIf, ɵNgNoValidate, DefaultValueAccessor, CheckboxControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, SanitizeHtmlPipe]
});
(() => {
...
DropdownComponent.ɵfac = function DropdownComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DropdownComponent)(ɵɵdirectiveInject(NgxEditorService), ɵɵdirectiveInject(MenuService), ɵɵdirectiveInject(ElementRef));
};
DropdownComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function DropdownComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtext(1);
      ɵɵelementEnd();
      ɵɵtemplate(2, DropdownComponent_div_2_Template, 2, 2, "div", 1);
    }
    if (rf & 2) {
...
ImageComponent.ɵfac = function ImageComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ImageComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgxEditorService), ɵɵdirectiveInject(MenuService));
};
ImageComponent.ɵcmp = ɵɵdefineComponent({
  type: ImageComponent,
  selectors: [["ngx-image"]],
  ...
  template: function ImageComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵproperty("innerHTML", ɵɵpipeBind1(1, 5, ctx.icon), ɵɵsanitizeHtml)("title", ctx.getLabel("insertImage"));
      ɵɵadvance(2);
      ɵɵproperty("ngIf", ctx.showPopup);
    }
  },
  dependencies: [NgIf, ɵNgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, SanitizeHtmlPipe]
});
(() => {
...
ColorPickerComponent.ɵfac = function ColorPickerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ColorPickerComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(MenuService), ɵɵdirectiveInject(NgxEditorService));
};
ColorPickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function ColorPickerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵelementEnd();
      ɵɵtemplate(2, ColorPickerComponent_div_2_Template, 4, 4, "div", 1);
    }
    if (rf & 2) {
      ɵɵclassProp("NgxEditor__MenuItem--Active", ctx.isActive || ctx.showPopup)("NgxEditor--Disabled", !ctx.canExecute);
      ɵɵproperty("innerHTML", ɵɵpipeBind1(1, 7, ctx.icon), ɵɵsanitizeHtml)("title", ctx.title);
  ...
  dependencies: [NgClass, NgForOf, NgIf, NgStyle, SanitizeHtmlPipe],
...
MenuComponent.ɵfac = function MenuComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MenuComponent)(ɵɵdirectiveInject(MenuService));
};
...
BubbleComponent.ɵfac = function BubbleComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || BubbleComponent)(ɵɵdirectiveInject(SanitizeHtmlPipe), ɵɵdirectiveInject(NgxEditorService));
};
BubbleComponent.ɵcmp = ɵɵdefineComponent({
...
var FloatingMenuComponent = class {
  constructor(el) {
    this.el = el;
...
FloatingMenuComponent.ɵfac = function FloatingMenuComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || FloatingMenuComponent)(ɵɵdirectiveInject(ElementRef));
};
FloatingMenuComponent.ɵcmp = ɵɵdefineComponent({
...
NgxEditorModule.ɵfac = function NgxEditorModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxEditorModule)();
};
NgxEditorModule.ɵmod = ɵɵdefineNgModule({
...
NgxEditorModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule, MenuModule]
});
(() => {
